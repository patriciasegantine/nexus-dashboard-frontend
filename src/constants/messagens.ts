export const AUTH_MESSAGES = {
  ...
  FORGOT_PASSWORD_SUCCESS: "If an account exists with this email, you will receive password reset instructions.",
  FORGOT_PASSWORD_FAIL: "Failed to process request. Please try again.",
